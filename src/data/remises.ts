...
export const initialRemises: Remise[] = [
  ...
  { idRemise: 'REM-004', taux: 0.25, typeRemise: TypeRemise.EXCEPTIONNELLE, produitReference: 'VN-001', dateDebut: '2026-06-01', dateFin: '2026-06-30', description: 'Promo exceptionnelle juin Sauternes — 25 %' },
]
